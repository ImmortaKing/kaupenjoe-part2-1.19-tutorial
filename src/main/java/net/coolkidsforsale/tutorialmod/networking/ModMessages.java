package net.coolkidsforsale.tutorialmod.networking;

import net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking;
import net.coolkidsforsale.tutorialmod.TutorialMod;
import net.coolkidsforsale.tutorialmod.networking.packet.DrinkingC2SPacket;
import net.coolkidsforsale.tutorialmod.networking.packet.ExampleC2SPacket;
